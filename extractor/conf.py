DATETIME_PATTERN = [
    ...
    "(?P<year>\d{4})年?[-|/.](?P<month>[0-1][1-9])月?[-|/.](?P<day>[0-3][0-9])日?\s*(?P<hour>\d{1,2}):(?P<minute>\d{1,2}):(?P<second>\d{1,2})",
    "(?P<year>\d{4})年?[-|/.](?P<month>[0-1][1-9])月?[-|/.](?P<day>[0-3][0-9])日?\s*(?P<hour>\d{1,2}):(?P<minute>\d{1,2})",
    ...
    "(?P<year>\d{4})年?[-|/.](?P<month>\d{1,2})月?[-|/.](?P<day>\d{1,2})日?\s*(?P<hour>\d{1,2}):(?P<minute>\d{1,2})",
    "(?P<month>\d{1,2})月?[-|/.](?P<day>\d{1,2})日?\s*(?P<hour>\d{1,2}):(?P<minute>\d{1,2})",
    "(?P<year>\d{2,4})?年?(?P<month>\d{1,2})月(?P<day>\d{1,2})日\s*(?P<hour>\d{1,2})?[:时]?(?P<minute>\d{1,2})?[:分]?(?P<second>\d{1,2})?",
